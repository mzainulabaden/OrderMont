...
namespace ERP.Modules.Finance.GeneralNote
{
    ...
    public class FINANCE_GeneralNoteDto : Entity<long>
    {
        ...
        public List<GeneralNoteDetailsDto>? GeneralNoteDetails { get; set; }
    }

    [AutoMap(typeof(GeneralNoteDetailsInfo))]
    public class GeneralNoteDetailsDto : Entity<long>
    {
